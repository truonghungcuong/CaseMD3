                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="/StoryServlet?action=viewByCategory&id=1">Truyện
                                    tranh</a></li>
                                <li><a class="dropdown-item" href="/StoryServlet?action=viewByCategory&id=2">Tiểu
                                    thuyết</a></li>
                            </ul>
                        </li>
                    </ul>
                        ...
                        <div class="content">
                            <div class="card"
                                ...
                                <a style="text-decoration: none"
                                   href="/StoryServlet?action=view&id=${story.getId()}"><img src="${story.getImg()}"
                                                                                             class="card-img-top"></a>
                                <div class="card-body">
                                    <a style="text-decoration: none"
                                       href="/StoryServlet?action=view&id=${story.getId()}"><h5 style="font-size: 20px"
                                                                                                class="card-title name">${story.getName()}</h5>
                                    </a>
