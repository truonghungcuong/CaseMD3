    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <h1>${requestScope['story'].getName()}</h1>
                <a class="btn btn-primary float-end" href="/parts?action=create&storyId=${requestScope['story'].getId()}&categoryId=${requestScope['story'].getCategoryId()}">Thêm tập truyện</a>
                <table style="text-align:center" class="table table-bordered">
                    <thead>
                    <tr>
                        <th>Số thứ tự</th>
                        <th>Mã truyện</th>
                        <th>Mã loại truyện</th>
                        <th>Tập</th>
                        <th>Tên tập</th>
                        <th>Nội dung</th>
                    ...
                    <c:forEach items="${requestScope['listPart']}" var="part">
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-info" href="/parts?action=update&id=${part.id}">Sửa<i
                                        class="fa fa-edit"></i></a>

                            <a class="btn btn-danger" href="/parts?action=delete&id=${part.id}">Xóa<i
