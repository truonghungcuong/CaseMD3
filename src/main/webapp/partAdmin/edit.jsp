        ...
        <section class="content">
            <div class="container-fluid">
                <div class="container">
                    ...
                    <a href="/parts">Quay lại trang tập truyện</a>

                    <form method="post">
                        <div class="mb-3">
                            <label  class="form-label">Tập</label>
                            <input type="text" class="form-control" name="episode" value = "${requestScope['part'].getEpisode()}">
                        </div>
                        <div class="mb-3">
                            <label  class="form-label">Tên tập</label>
                            <input type="text" class="form-control" name="partName"value = "${requestScope['part'].getName()}">
                        </div>

                        <div class="mb-3">
                            <label  class="form-label">Nội dung</label>
                            <input type="text" class="form-control"  name="content" value = "${requestScope['part'].getContent()}">
                        </div>
